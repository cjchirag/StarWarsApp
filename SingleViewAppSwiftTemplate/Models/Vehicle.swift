...
class Vehicle: AllowData {
    ...
    init(Name: String, Make: String, CostInCredits: String, Length: String, Class: String, Crew: String, Model: String, CargoCap: String, Passengers: String, MaxSpeed: String, films: [String], Consumables: String, Pilots: [String]) {
        self.Name = Name
        self.Make = Make
